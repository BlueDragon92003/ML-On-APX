...
class TestDatasetSubset(unittest.TestCase):
    ...
    def test_dataset_subset__get_hex(self, name: str, bitstring: int, expected: str):
    ...
    def test_dataset_subset__get_data(
        self, name: str, data: Set[Tuple[str, SignalType]]
    ):
    ...
    def test_dataset_subset__len(
        self, name: str, data: Set[Tuple[str, SignalType]], length: int
    ):
    ...
    def test_dataset_subset__combo__get_hex(
        self, name: str, hex1: int, hex2: int, expected: str
    ):
    ...
    def test_dataset_subset__combo__get_data(
        self,
        name: str,
    ...
    def test_dataset_subset__combo__len(
        self,
        name: str,
        data1: Set[Tuple[str, SignalType]],
        data2: Set[Tuple[str, SignalType]],
