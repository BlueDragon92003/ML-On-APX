...
class TestLoadData(unittest.TestCase, TestCaseMixin):
    ...
    def setUpClass(cls):
        ...
        # Age 0
        cls.files["data_1"] = cls.ffs.create_file(cls.paths["root"] / "data_1.root")
        cls.files["data_2"] = cls.ffs.create_file(cls.paths["root"] / "data_2.root")
        ...
        # Age 2
        cls.files["ccd"] = cls.ffs.create_file(
            cls.paths["module"] / "cluster_classification_dataset.py"
        )
        #   Increment age
        cls.files["data_1"].set_contents("")
        cls.files["data_2"].set_contents("")
        ...
        cls.files["old_fmt_pckl"].set_contents(
            pickle.dumps(
                Mock_ClusterClassificationDataset(
                    set(
                        [
                            (
                                str(cls.paths["root"] / "data_1.root"),
                                SignalType.BACKGROUND,
                            ),
                            (
                                str(cls.paths["root"] / "data_3.root"),
                                SignalType.BACKGROUND,
                            ),
                        ]
                    )
                ...
                Mock_ClusterClassificationDataset(
                    set(
                        [
                            ...
                            (
                                str(cls.paths["root"] / "data_n.root"),
                                SignalType.BACKGROUND,
                            ),
                        ]
                    )
                ...
                Mock_ClusterClassificationDataset(
                    set(
                        [
                            ...
                            (
                                str(cls.paths["root"] / "data_2.root"),
                                SignalType.BACKGROUND,
                            ),
                        ]
                    )
