...
class TestClusterClassificationDataset(unittest.TestCase):
    ...
    def __data_for__test_ccd__cluster_generator__correctness(
        ...
        logger.log_enter_function(
            "data_for_cluster_generator_correctness",
            feature=feature,
            event=event,
            card=card,
            final=final,
            ...
            match feature:
                case "SLR0_cluster_eta":
                    if final == 0:  # cluster position
                        logger.log_function_exit_type("return", retval=0)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 0
                case "SLR0_cluster_phi":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=10)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 10
                ...
                case "SLR0_cluster_seed_energy":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=2)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 2
                case "SLR0_cluster_et5x5":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=3)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 3
                case "SLR0_cluster_et2x5":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=4)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 4
                case "SLR0_cluster_timing":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=5)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 5
                case "SLR0_cluster_spike":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=6)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 6
                case "SLR0_cluster_brems":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=7)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 7
                case "SLR0_cluster_satur":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=8)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 8
                case "SLR0_cluster_spare":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=9)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 9
                ...
                case "ECALUnclusteredSLR0_tower_timing":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=11)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 11
                case "ECALUnclusteredSLR0_tower_spike":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=12)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 12
                ...
                case "HCAL5_tower_et":
                    if final == 0:  # hcal tower
                        logger.log_function_exit_type("return", retval=13)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 13
                case "HCAL5_tower_fb":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=14)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 14
                ...
                case _:
                    logger.log_function_exit_type("return", retval=0)
                    logger.log_exit_function("data_for_cluster_generator_correctness")
                    return 0
            logger.log_function_exit_type("return", retval=0)
            logger.log_exit_function("data_for_cluster_generator_correctness")
            return 0
        ...
        if event == 0 and card == 3:
            match feature:
                ...
                case "SLR1_cluster_phi":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=1)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 1
                ...
                case "SLR1_cluster_brems":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=17)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 17
                case "SLR1_cluster_satur":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=23)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 23
                case "SLR1_cluster_spare":
                    if final == 2:
                        logger.log_function_exit_type("return", retval=29)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 29
                ...
                case "ECALUnclusteredSLR1_tower_et":
                    if final == 0:  # ecal tower
                        logger.log_function_exit_type("return", retval=31)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 31
                case "ECALUnclusteredSLR1_tower_timing":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=37)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 37
                case "ECALUnclusteredSLR1_tower_spike":
                    if final == 0:
                        logger.log_function_exit_type("return", retval=41)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 41
                ...
                case "HCAL7_tower_et":
                    if final == 10:  # hcal tower
                        logger.log_function_exit_type("return", retval=43)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 43
                case "HCAL7_tower_fb":
                    if final == 10:
                        logger.log_function_exit_type("return", retval=47)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 47
            ...
            match feature:
                case "SLR2_cluster_eta":
                    if final == 4:  # cluster position
                        logger.log_function_exit_type("return", retval=54)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 54
                case "SLR2_cluster_phi":
                    if final == 4:
                        logger.log_function_exit_type("return", retval=16)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 16
                ...
                case "SLR2_cluster_satur":
                    if final == 4:
                        logger.log_function_exit_type("return", retval=21)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 21
                case "SLR2_cluster_spare":
                    if final == 4:
                        logger.log_function_exit_type("return", retval=34)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 34
                ...
                case "ECALUnclusteredSLR2_tower_et":
                    if final == 21:  # ecal tower
                        logger.log_function_exit_type("return", retval=55)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 55
                case "ECALUnclusteredSLR2_tower_timing":
                    if final == 21:
                        logger.log_function_exit_type("return", retval=-39)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return -39
            ...
            match feature:
                case "SLR3_cluster_eta":
                    if final == 5:  # cluster position
                        logger.log_function_exit_type("return", retval=76)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 76  # trombones
            ...
            match feature:
                case "SLR3_cluster_eta":
                    if final == 7:  # cluster position
                        logger.log_function_exit_type("return", retval=84)
                        logger.log_exit_function(
                            "data_for_cluster_generator_correctness"
                        )
                        return 84
